...
const countries=fetch("https://restcountries.com/v3.1/all?fields=capital,flags,continents,name,population")
                ...
                .then((data) => {
                    data.forEach((country) =>{
                        ...
                        countryPopulation.append(`${country.population.toLocaleString('en-IN')}`)
                        boldText = null
