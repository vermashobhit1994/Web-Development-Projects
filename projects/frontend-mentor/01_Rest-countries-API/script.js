...
function renderCountries(data) {
    data.forEach((country) => {
        ...
        const lastCapitalIndex = country.capital.length - 1;
        const capitals = "";
        ...
        searchInput.addEventListener("input", (e) => {
            ...
            if (allCountriesData) {
                ...
                if (filteredCountries.length == 0) {
                    ...
                    countriesNotFound.innerText =
                        "No country found for matching criteria";
