    ...
    .then((resp) => resp.json())
        ...
        if(country?.name?.nativeName){
            ...
            if(Object.keys(nativeNames).length == 1){
                ...
                for (const language of Object.keys(countriesNativeLanguages)){
        ...
        if(country?.currencies){
            ...
            for (const currencyCodeValue of currenciesSorted){
        ...
        if(country?.languages){
            ...
            for (const languages of languagesSorted){
        ...
        if(country?.borders){
            ...
            for(const countryCode of borderCountriesCodes){
...
//     // window.localStorage.setItem(`colorTheme`, mode)
//     console.log(window.localStorage.getItem(`1`))
//     window.localStorage.setItem("1", 'world')
